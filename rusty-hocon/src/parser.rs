...
mod tests {
    ...
    fn test_concat_unquoted_strings(#[case] input: &str, #[case] a_quoted: bool, #[case] b_quoted: bool) {
        ...
        assert_eq!(parse::<VerboseError<&str>>(input), Ok(HoconValue::Object(expected)));
    }
    ...
    #[case::string_number("one 12", HoconValue::String(HoconString::Unquoted("one")), HoconValue::Number(12.0))]
    ...
    #[test]
    fn test_number() {
        assert_eq!(number::<VerboseError<&str>>("42"), Ok(("", HoconValue::Number(42f64))));
    }
    ...
    fn parse_array_concat() {
        ...
        assert_eq!(parse::<VerboseError<&str>>(content), Ok(HoconValue::Object(expected)));
    }
